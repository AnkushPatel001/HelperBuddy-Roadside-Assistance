...
import com.example.helperbuddy.databinding.ActivityLoginBinding
import com.example.helperbuddy.Activity.MainActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge() // Make sure this is set up correctly
        ...
        binding.login2.setOnClickListener {
            val email = binding.editTextPhone.text.toString().trim() // Changed to editTextEmail
            val password = binding.editText.text.toString().trim() // Changed to editTextPassword
